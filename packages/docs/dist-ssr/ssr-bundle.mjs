...
var liftValue = (arg) => arg?.[reactiveSymbol] ? arg.get() : arg;
...
var createAttribute = ([key, value]) => htmlEventList.has(key) ? "" : value?.[reactiveSymbol] ? lift((value2) => printAttribute(key, value2()), [value]) : printAttribute(key, value);
...
var Router = class {
  ...
  findRecursive(remain, node, params) {
    ...
    for (const k2 in node.children.regex) {
      child = node.children.regex[k2];
      if (child.regex) {
...
var Router2 = ({ props: { routes } }) => {
  ...
  return createJsxExpression((currentRoute2) => currentRoute2()?.handler, [currentRoute]);
};
var push = (href) => {
  navigate(href);
...
var A = ({ props, children }) => createElement("a", computed((props2) => ({
  ...props2(),
  onclick: (e) => {
    e.preventDefault();
    props2().onclick?.(e);
...
var True = createToken({
  name: "True",
  pattern: /true\b/,
  longer_alt: Identifier
});
var False = createToken({
  name: "False",
  pattern: /false\b/,
  longer_alt: Identifier
});
var Null = createToken({
  name: "Null",
  pattern: /null\b/,
  longer_alt: Identifier
});
var Typeof = createToken({
  name: "Typeof",
  pattern: /typeof\b/,
  longer_alt: Identifier
});
var Void = createToken({
  name: "Void",
  pattern: /void\b/,
  longer_alt: Identifier
});
var Delete = createToken({
  name: "Delete",
  pattern: /delete\b/,
  longer_alt: Identifier
});
var Instanceof = createToken({
  name: "Instanceof",
...
var Export = createToken({
  name: "Export",
  pattern: /export\b/,
  longer_alt: Identifier
});
var Import = createToken({
  name: "Import",
  pattern: /import\b/,
  longer_alt: Identifier
});
...
var TemplateLiteral = createToken({
...
var PlusPlus = createToken({ name: "PlusPlus", pattern: /\+\+/ });
var MinusMinus = createToken({ name: "MinusMinus", pattern: /--/ });
var Plus = createToken({ name: "Plus", pattern: /\+/ });
var Minus = createToken({ name: "Minus", pattern: /-/ });
var StarStar = createToken({ name: "StarStar", pattern: /\*\*/ });
...
var LessThanEqual = createToken({ name: "LessThanEqual", pattern: /<=/ });
var GreaterThanEqual = createToken({ name: "GreaterThanEqual", pattern: />=/ });
var Pipe = createToken({ name: "Pipe", pattern: /\|>/ });
var Compose = createToken({ name: "Compose", pattern: /<\|/ });
var LessThan = createToken({ name: "LessThan", pattern: /</ });
var GreaterThan = createToken({ name: "GreaterThan", pattern: />/ });
var EqualEqual = createToken({ name: "EqualEqual", pattern: /==/ });
var BangEqual = createToken({ name: "BangEqual", pattern: /!=/ });
var AndAnd = createToken({ name: "AndAnd", pattern: /&&/ });
var OrOr = createToken({ name: "OrOr", pattern: /\|\|/ });
var QuestionDot = createToken({ name: "QuestionDot", pattern: /\?\./ });
var QuestionQuestion = createToken({ name: "QuestionQuestion", pattern: /\?\?/ });
var Question = createToken({ name: "Question", pattern: /\?/ });
var ColonEqual = createToken({ name: "ColonEqual", pattern: /:=/ });
var Colon = createToken({ name: "Colon", pattern: /:/ });
var Bang = createToken({ name: "Bang", pattern: /!/ });
...
var UnsignedRightShift = createToken({ name: "UnsignedRightShift", pattern: />>>/ });
var PlusColonEqual = createToken({ name: "PlusColonEqual", pattern: /\+:=/ });
var MinusColonEqual = createToken({ name: "MinusColonEqual", pattern: /-:=/ });
var StarStarColonEqual = createToken({ name: "StarStarColonEqual", pattern: /\*\*:=/ });
var StarColonEqual = createToken({ name: "StarColonEqual", pattern: /\*:=/ });
var SlashColonEqual = createToken({ name: "SlashColonEqual", pattern: /\/:=/ });
var PercentColonEqual = createToken({ name: "PercentColonEqual", pattern: /%:=/ });
var LeftShiftColonEqual = createToken({ name: "LeftShiftColonEqual", pattern: /<<:=/ });
var RightShiftColonEqual = createToken({ name: "RightShiftColonEqual", pattern: />>:=/ });
var UnsignedRightShiftColonEqual = createToken({ name: "UnsignedRightShiftColonEqual", pattern: />>>:=/ });
var AndColonEqual = createToken({ name: "AndColonEqual", pattern: /&:=/ });
var CaretColonEqual = createToken({ name: "CaretColonEqual", pattern: /\^:=/ });
var OrColonEqual = createToken({ name: "OrColonEqual", pattern: /\|:=/ });
var Equal = createToken({ name: "Equal", pattern: /=/ });
var LeftParen = createToken({ name: "LeftParen", pattern: /\(/ });
var RightParen = createToken({ name: "RightParen", pattern: /\)/ });
var LeftBracket = createToken({ name: "LeftBracket", pattern: /\[/ });
var RightBracket = createToken({ name: "RightBracket", pattern: /\]/ });
var LeftBrace = createToken({ name: "LeftBrace", pattern: /\{/ });
var RightBrace = createToken({ name: "RightBrace", pattern: /\}/ });
var Comma = createToken({ name: "Comma", pattern: /,/ });
var Dot = createToken({ name: "Dot", pattern: /\./ });
var DotDotDot = createToken({ name: "DotDotDot", pattern: /\.\.\./ });
var Semicolon = createToken({ name: "Semicolon", pattern: /;/ });
var JSXCloseTagStart = createToken({ name: "JSXCloseTagStart", pattern: /<\// });
var JSXSelfClosing = createToken({ name: "JSXSelfClosing", pattern: /\/>/ });
...
var MultiLineComment = createToken({
...
function highlightOddo(code) {
  ...
  const allTokenInstances = [...tokens, ...comments].sort((a2, b2) => a2.startOffset - b2.startOffset);
  let html = "";
  let lastEnd = 0;
...
var GuidePage = () => {
  ...
  return createElement("div", {
    ...
    class: "doc-hero"
  }, createElement("h1", null, "Welcome to Oddo"), createElement("p", {
    class: "doc-lead"
  }, "A functional reactive programing language.")), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "What is Oddo?"), createElement("p", null, "Oddo is an experimental language intended for reactive programming. It is a JavaScript dialect that treats reactivity as a first-class language primitive and places a stronger emphasis on data immutability."), createElement("p", null, "Oddo ships with its own UI rendering library for fine-grained reactivity and built-in JSX support.")), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Key Differentiators"), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Arrow Function Components"), createElement("p", null, "Components are simple arrow functions. Reactive state and mutations are declared inline with modifiers."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, code1) => e()("code", {
    innerHTML: highlightOddo2()(code1())
  }), [createElement, highlightOddo, code1_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Mutation with :="), createElement("p", null, "Oddo distinguishes binding (=) from mutation (:=). This makes state changes explicit and predictable."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, code2) => e()("code", {
    innerHTML: highlightOddo2()(code2())
  }), [createElement, highlightOddo, code2_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Value decorators"), createElement("p", null, "Reactive primitives use the", createJsxExpression((atSign2) => atSign2(), [atSign]), "prefix for clarity. At a glance, you know what is reactive."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, code3) => e()("code", {
    innerHTML: highlightOddo2()(code3())
  }), [createElement, highlightOddo, code3_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "JSX-First UI"), createElement("p", null, "JSX is a first-class citizen. Build reactive interfaces naturally with familiar syntax."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, code4) => e()("code", {
    innerHTML: highlightOddo2()(code4())
  }), [createElement, highlightOddo, code4_default])))), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Hello World"), createElement("p", null, "Here is the simplest Oddo application:"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, code5) => e()("code", {
    innerHTML: highlightOddo2()(code5())
  }), [createElement, highlightOddo, code5_default])), createElement("p", null, "That is it. No boilerplate, no configuration. Just write and run.")), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Ready to Explore?"), createElement("p", null, "Head to the", createComponent(A, {
    href: "/api"
  }, "API"), "tab to learn about all the features, or jump into the", createComponent(A, {
    href: "/playground"
  }, "Playground"), "to start writing code immediately."))));
};
...
// .temp-ssr/pages/api/codeMutate.js
var codeMutate_default = `@mutate increment = () => {
  count := count + 1
}
...
var APIPage = () => {
  ...
  return createElement("div", {
    ...
    class: "doc-hero"
  }, createElement("h1", null, "API Reference"), createElement("p", {
    class: "doc-lead"
  }, "Complete documentation of Oddo reactive primitives, operators, and syntax.")), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Reactive Primitives"), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, createJsxExpression((atSign2) => atSign2(), [atSign]), "state"), createElement("p", null, "Declares reactive state. When state changes, dependent UI automatically updates."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeState) => e()("code", {
    innerHTML: highlightOddo2()(codeState())
  }), [createElement, highlightOddo, codeState_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, createJsxExpression((atSign2) => atSign2(), [atSign]), "computed"), createElement("p", null, "Derives values from state. Automatically recalculates when dependencies change."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeComputed) => e()("code", {
    innerHTML: highlightOddo2()(codeComputed())
  }), [createElement, highlightOddo, codeComputed_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, createJsxExpression((atSign2) => atSign2(), [atSign]), "effect"), createElement("p", null, "Runs side effects when dependencies change. Perfect for logging, API calls, or DOM manipulation."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeEffect) => e()("code", {
    innerHTML: highlightOddo2()(codeEffect())
  }), [createElement, highlightOddo, codeEffect_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, createJsxExpression((atSign2) => atSign2(), [atSign]), "mutate"), createElement("p", null, "Defines mutation functions that can safely modify state. Enables batched updates."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeMutate) => e()("code", {
    innerHTML: highlightOddo2()(codeMutate())
  }), [createElement, highlightOddo, codeMutate_default])))), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Operators"), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Assignment vs Mutation"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeOps) => e()("code", {
    innerHTML: highlightOddo2()(codeOps())
  }), [createElement, highlightOddo, codeOps_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Equality"), createElement("p", null, "Oddo simplifies equality: == always compiles to JavaScript === (strict equality). No type coercion surprises."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeEquality) => e()("code", {
    innerHTML: highlightOddo2()(codeEquality())
  }), [createElement, highlightOddo, codeEquality_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "All Standard Operators"), createElement("p", null, "Arithmetic, logical, comparison, and bitwise operators work as expected."), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeAllOps) => e()("code", {
    innerHTML: highlightOddo2()(codeAllOps())
  }), [createElement, highlightOddo, codeAllOps_default])))), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Data Types"), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Primitives"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codePrimitives) => e()("code", {
    innerHTML: highlightOddo2()(codePrimitives())
  }), [createElement, highlightOddo, codePrimitives_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Arrays"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeArrays) => e()("code", {
    innerHTML: highlightOddo2()(codeArrays())
  }), [createElement, highlightOddo, codeArrays_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Objects"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeObjects) => e()("code", {
    innerHTML: highlightOddo2()(codeObjects())
  }), [createElement, highlightOddo, codeObjects_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Arrow Functions"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeArrows) => e()("code", {
    innerHTML: highlightOddo2()(codeArrows())
  }), [createElement, highlightOddo, codeArrows_default])))), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "JSX Syntax"), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Elements and Components"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeElements) => e()("code", {
    innerHTML: highlightOddo2()(codeElements())
  }), [createElement, highlightOddo, codeElements_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Attributes and Expressions"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeAttrs) => e()("code", {
    innerHTML: highlightOddo2()(codeAttrs())
  }), [createElement, highlightOddo, codeAttrs_default]))), createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Children and Nesting"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeNesting) => e()("code", {
    innerHTML: highlightOddo2()(codeNesting())
  }), [createElement, highlightOddo, codeNesting_default])))), createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Component Structure"), createElement("p", null, "Components are arrow functions with curly braces. State, mutations, and the return statement go inside:"), createElement("pre", {
    class: "doc-code-block"
  }, createJsxExpression((e, highlightOddo2, codeBlock) => e()("code", {
    innerHTML: highlightOddo2()(codeBlock())
  }), [createElement, highlightOddo, codeBlock_default])))));
};
...
var f = { openTagStart: new RegExp("<[a-zA-Z][\\w-]*"), closeTag: new RegExp("</[a-zA-Z][\\w-]*>"), tagEnd: new RegExp(">"), attribute: new RegExp(`[^\\s/>"'=]+(?=\\s*=)`), equals: new RegExp("="), whitespace: new RegExp("\\s+") };
var D = { tag: [f.openTagStart, f.closeTag, f.tagEnd], attribute: [f.attribute], string: [s.stringDouble, s.stringSingle].map((r) => new RegExp(r.source, r.flags)), comment: [/<!--(?:(?!-->)[\s\S])*-->/].map((r) => new RegExp(r.source, r.flags)), doctype: [new RegExp("<!DOCTYPE(?:\\s+[^>]+)?\\s*>", "i")], entity: [new RegExp("&(?:#x[a-f0-9]+|#[0-9]+|[a-z0-9]+);", "i")], identifier: [new RegExp("[a-zA-Z][\\w-]*")] };
var k = { keyword: [new RegExp("\\b(?:const|let|var|function|return|if|else|for|while|do|break|continue|class|extends|new|this)\\b")], string: [s.stringDouble, s.stringSingle, s.stringBacktick].map((r) => new RegExp(r.source, r.flags)), number: [s.number].map((r) => new RegExp(r.source, r.flags)), comment: [s.lineComment, s.blockComment].map((r) => new RegExp(r.source, r.flags)), punctuation: [new RegExp("[{}()\\[\\],.;]")], operator: [new RegExp("[+\\-*/%=<>!&|^~?:]+")], identifier: [s.identifier].map((r) => new RegExp(r.source, r.flags)) };
var v = { number: new RegExp("-?(?:0|[1-9]\\d*)(?:\\.\\d+)?(?:[eE][+-]?\\d+)?\\b"), keyword: new RegExp("\\b(?:true|false|null)\\b") };
var T = { string: [s.stringDouble].map((r) => new RegExp(r.source, r.flags)), number: [v.number], keyword: [v.keyword], punctuation: [new RegExp("[{}()\\[\\],:]")], identifier: [new RegExp("[a-zA-Z_][\\w$]*")] };
var E = { heading: new RegExp("^#{1,6}\\s+.*$", "m"), boldAsterisk: new RegExp("\\*\\*(?:[^*]|\\*(?!\\*))+\\*\\*"), boldUnderscore: new RegExp("__(?:[^_]|_(?!_))+__"), italicAsterisk: new RegExp("\\*(?:[^*]|\\*\\*)+?\\*"), italicUnderscore: new RegExp("_(?:[^_]|__)+?_"), link: new RegExp('\\[([^\\[\\]]|\\[[^\\[\\]]*])*\\]\\([^()\\s]+(?:\\s+"[^"]*")?\\)'), image: new RegExp('!\\[([^\\[\\]]|\\[[^\\[\\]]*])*\\]\\([^()\\s]+(?:\\s+"[^"]*")?\\)'), inlineCode: new RegExp("`[^`]+`"), codeBlock: new RegExp("```[\\s\\S]+?```"), unorderedList: new RegExp("^\\s*[-*+]\\s+.+$", "m"), orderedList: new RegExp("^\\s*\\d+\\.\\s+.+$", "m"), blockquote: new RegExp("^>\\s+.+$", "m"), horizontalRule: new RegExp("^(?:[-*_]){3,}$", "m") };
var j = { heading: [E.heading], emphasis: [E.boldAsterisk, E.boldUnderscore, E.italicAsterisk, E.italicUnderscore], link: [E.link], image: [E.image], code: [E.inlineCode, E.codeBlock], list: [E.unorderedList, E.orderedList], blockquote: [E.blockquote], horizontalRule: [E.horizontalRule], identifier: [new RegExp("[a-zA-Z][\\w-]*")] };
var P = { stringTripleDouble: new RegExp('"""(?:\\\\[\\s\\S]|[^\\\\])*?"""'), stringTripleSingle: new RegExp("'''(?:\\\\[\\s\\S]|[^\\\\])*?'''"), lineComment: [/#[^\n]*/].map((r) => new RegExp(r.source, r.flags)) };
var q = { keyword: [new RegExp("\\b(?:def|class|if|else|elif|for|while|break|continue|return|import|from|as|try|except|finally|raise|with|lambda)\\b")], string: [P.stringTripleDouble, P.stringTripleSingle, s.stringDouble, s.stringSingle].map((r) => new RegExp(r.source, r.flags)), number: [s.number].map((r) => new RegExp(r.source, r.flags)), comment: P.lineComment, punctuation: [new RegExp("[{}()\\[\\],.;:]")], operator: [new RegExp("[+\\-*/%=<>!&|^~@]+")], identifier: [s.identifier].map((r) => new RegExp(r.source, r.flags)) };
var U = { keyword: [new RegExp("\\b(?:const|let|var|function|return|if|else|for|while|do|break|continue|class|extends|new|this|interface|type|namespace|enum|implements|private|protected|public|static|readonly|as|keyof|typeof|instanceof)\\b")], string: [s.stringDouble, s.stringSingle, s.stringBacktick].map((r) => new RegExp(r.source, r.flags)), number: [s.number].map((r) => new RegExp(r.source, r.flags)), comment: [s.lineComment, s.blockComment].map((r) => new RegExp(r.source, r.flags)), punctuation: [new RegExp("[{}()\\[\\],.;:]")], operator: [new RegExp("[+\\-*/%=<>!&|^~?]+")], identifier: [s.identifier].map((r) => new RegExp(r.source, r.flags)) };
var L = { javascript: k, python: q, typescript: U, html: D, css: $, json: T, markdown: j };
var F = /* @__PURE__ */ new Map([[38, "&amp;"], [60, "&lt;"], [62, "&gt;"], [34, "&quot;"], [39, "&#039;"]]);
var O = /^\s+/;
function B(r) {
  let e = "", w = 0;
  for (let o = 0; o < r.length; o++) {
    let i = r.charCodeAt(o), m = F.get(i);
    if (m) {
      if (w < o) e += r.slice(w, o);
      e += m, w = o + 1;
    }
  }
  if (w < r.length) e += r.slice(w);
  return e;
}
function b(r, e) {
  let w = [], o = L[e];
  if (!o) return [{ type: "text", content: r }];
  let i = 0, m = null, n = "", t = r.length, R = () => {
    if (n && m) w.push({ type: m, content: n }), n = "", m = null;
  };
  while (i < t) {
    let g = false, l = r.slice(i);
    for (let [x, p] of Object.entries(o)) {
      if (Array.isArray(p)) for (let d of p) {
        d.lastIndex = 0;
        let A2 = d.exec(l);
        if (A2 && A2.index === 0) {
          let _ = A2[0], Z = x === "identifier" && e !== "typescript" ? "text" : x;
          if (Z === m) n += _;
          else R(), m = Z, n = _;
          i += _.length, g = true;
          break;
...
function c(r, e) {
  let w = b(r, e), o = new Array(w.length);
  for (let i = 0; i < w.length; i++) {
    let m = w[i], n = B(m.content);
    o[i] = `<span class="bh-npm-token bh-npm-${m.type}">${n}</span>`;
  }
  return o.join("");
}
...
Counter = () => {
  @state count = 0
  @mutate modifyCount = (amount) => {
    count := count + amount
  }
  increment = () => { modifyCount(1) }
  decrement = () => { modifyCount(-1) }
...
StyledBox = () => {
  return <div class="box" style="padding: 10px; background: #eee;">
    Styled content
  </div>
}
...
App = () => {
  ...
  @mutate incrementCount = () => {
    count := count + 1
  }

  @mutate setName = (newName) => {
    name := newName
  }

  @effect () => console.log("Greeting changed:", greeting)

  return <div style="padding: 20px; font-family: sans-serif;">
    <h2>{greeting}</h2>
    <p>Count: {count} (doubled: {doubled})</p>
    <button onclick={incrementCount}>Increment</button>
    <button onclick={() => { setName("Oddo") }}>Change Name</button>
  </div>
}
...
var Playground = () => {
  ...
  const [outputMode, setOutputMode] = state("js");
  const [hasError, setHasError] = state(false);
  const [parseTime, setParseTime] = state("--");
  const [nodeCount, setNodeCount] = state("--");
  const [outputSize, setOutputSize] = state("--");
  const [lastAST, setLastAST] = state(null);
  const [lastJS, setLastJS] = state(null);
  const updateInput = transact((finalizer, input2, value) => {
    input2 = stateProxy(value);
    finalizer(input2());
  }, (input2) => setInput(input2), [input], []);
  const updateOutput = transact((finalizer, output2, value) => {
    output2 = stateProxy(value);
    finalizer(output2());
  }, (output2) => setOutput(output2), [output], []);
  const updateOutputMode = transact((finalizer, outputMode2, value) => {
    outputMode2 = stateProxy(value);
    finalizer(outputMode2());
  }, (outputMode2) => setOutputMode(outputMode2), [outputMode], []);
  const updateHasError = transact((finalizer, hasError2, value) => {
    hasError2 = stateProxy(value);
    finalizer(hasError2());
  }, (hasError2) => setHasError(hasError2), [hasError], []);
  const updateParseTime = transact((finalizer, parseTime2, value) => {
    parseTime2 = stateProxy(value);
    finalizer(parseTime2());
  }, (parseTime2) => setParseTime(parseTime2), [parseTime], []);
  const updateNodeCount = transact((finalizer, nodeCount2, value) => {
    nodeCount2 = stateProxy(value);
    finalizer(nodeCount2());
  }, (nodeCount2) => setNodeCount(nodeCount2), [nodeCount], []);
  const updateOutputSize = transact((finalizer, outputSize2, value) => {
    outputSize2 = stateProxy(value);
    finalizer(outputSize2());
  }, (outputSize2) => setOutputSize(outputSize2), [outputSize], []);
  const updateLastAST = transact((finalizer, lastAST2, value) => {
    lastAST2 = stateProxy(value);
    finalizer(lastAST2());
  }, (lastAST2) => setLastAST(lastAST2), [lastAST], []);
  const updateLastJS = transact((finalizer, lastJS2, value) => {
    lastJS2 = stateProxy(value);
    finalizer(lastJS2());
  }, (lastJS2) => setLastJS(lastJS2), [lastJS], []);
  const doCompile = liftFn((input2) => {
    const code = input2;
  ...
  const sendCompile = (code) => {
    ...
    }).then((res) => res.json()).then((result) => handleResult(result, startTime)).catch((err) => handleError(err.message));
  };
  const handleResult = (result, startTime) => {
    const elapsed = lift((startTime2) => Math.round(performance.now() - startTime2), [startTime]);
    result.error ? handleError(result.error) : handleSuccess(result, elapsed);
  };
  const handleSuccess = (result, elapsed) => {
    updateHasError(false);
  ...
  const showOutput = liftFn((outputMode2) => {
    const mode = outputMode2;
    const outputEl = document.getElementById("output-area");
    mode === "js" ? showJSOutput(outputEl) : showASTOutput(outputEl);
  }, [outputMode]);
  const showJSOutput = liftFn((lastJS2, el) => {
    el ? el.innerHTML = c(String(lastJS2), "javascript") : null;
  }, [lastJS]);
  const showASTOutput = liftFn((lastAST2, el) => {
    const astStr = JSON.stringify(lastAST2, null, 2);
    el ? el.textContent = astStr : null;
  }, [lastAST]);
  const countNodes = (obj) => {
    obj === null ? 0 : typeof obj !== "object" ? 0 : Object.keys(obj).reduce(liftFn((obj2, sum, k2) => sum + countNodes(obj2[k2]), [obj]), 1);
  };
  const examples = {
  ...
  const loadExample = (name) => {
    name === "" ? null : applyExample(examples[name]);
  };
  const applyExample = (code) => {
    updateInput(code);
    syncHighlightFromCode(code);
    document.getElementById("input-area").value = code;
    doCompile();
  };
  const toggleMode = liftFn((lastJS2, mode) => {
    updateOutputMode(mode);
    lastJS2 ? showOutput() : null;
  }, [lastJS]);
  const runPreview = liftFn((lastJS2) => {
    const js = lastJS2;
    js ? executePreview(js) : null;
  }, [lastJS]);
  const executePreview = (js) => {
  ...
  return createElement("div", {
    ...
    class: "panel-header"
  }, createElement("h3", null, "Input"), createElement("select", {
    onchange: computed((loadExample2) => (e) => {
      loadExample2()(e.target.value);
    }, [loadExample])
  }, createElement("option", {
    value: ""
  }, "Load example..."), createElement("option", {
    value: "counter"
  }, "Counter"), createElement("option", {
    value: "computed"
  }, "Computed"), createElement("option", {
    value: "primitives"
  }, "Primitives"), createElement("option", {
    value: "operators"
  }, "Operators"), createElement("option", {
    value: "jsx"
  }, "JSX"), createElement("option", {
    value: "modifiers"
    ...
    oninput: computed((handleInputEvent2) => (e) => {
      handleInputEvent2()(e.target.value);
    }, [handleInputEvent]),
    onkeydown: computed((handleKeyDownEvent2) => (e) => {
      handleKeyDownEvent2()(e);
    }, [handleKeyDownEvent]),
    onscroll: computed((handleScrollEvent2) => (e) => {
      handleScrollEvent2()(e.target);
    }, [handleScrollEvent]),
    ...
    class: "panel-header"
  }, createElement("h3", null, "Output"), createElement("div", {
    class: "output-toggle"
  }, createElement("button", {
    class: computed((outputMode2) => outputMode2() === "js" ? "active" : "", [outputMode]),
    onclick: computed((toggleMode2) => () => {
      toggleMode2()("js");
    }, [toggleMode])
  }, "JS"), createElement("button", {
    class: computed((outputMode2) => outputMode2() === "ast" ? "active" : "", [outputMode]),
    onclick: computed((toggleMode2) => () => {
      toggleMode2()("ast");
    }, [toggleMode])
  }, "AST"))), createElement("div", {
    class: "panel-content"
  }, createElement("div", {
    id: "output-area",
    class: computed((hasError2) => hasError2() ? "output-area error" : "output-area", [hasError])
  }, createJsxExpression((output2) => output2(), [output]))), createElement("div", {
    class: "stats-bar"
  }, createElement("span", null, "Parse:", createJsxExpression((parseTime2) => parseTime2(), [parseTime])), createElement("span", null, "Nodes:", createJsxExpression((nodeCount2) => nodeCount2(), [nodeCount])), createElement("span", null, "Size:", createJsxExpression((outputSize2) => outputSize2(), [outputSize]))))), createElement("div", {
    class: "preview-section"
  }, createElement("div", {
    class: "preview-header"
  }, createElement("h3", null, "Preview"), createElement("button", {
    class: "run-btn",
    onclick: computed((runPreview2) => runPreview2(), [runPreview])
  }, "Run")), createElement("div", {
...
var App = () => {
  return createElement("div", {
    ...
    class: "logo"
  }, "<oddo/>"), createElement("div", {
    class: "divider"
  }), createElement("nav", {
    class: "nav-tabs"
  }, createElement("button", {
    class: "nav-tab",
    onclick: computed((navigation2) => () => {
      navigation2().push("/");
    }, [navigation])
  }, "Guide"), createElement("button", {
    class: "nav-tab",
    onclick: computed((navigation2) => () => {
      navigation2().push("/api");
    }, [navigation])
  }, "API"), createElement("button", {
    class: "nav-tab",
    onclick: computed((navigation2) => () => {
      navigation2().push("/playground");
    }, [navigation])
  }, "Playground"))), createElement("main", {
    class: "main-content"
  }, createComponent(Router2, {
    routes: computed((GuidePage2, APIPage2, Playground2) => ({
      "/": createComponent(GuidePage2(), null),
      "/api": createComponent(APIPage2(), null),
      "/playground": createComponent(Playground2(), null),
      "(.*)": "Not found"
    }), [guide_default, api_default, playground_default])
  })));
};
var app_default = App;
