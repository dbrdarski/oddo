...
var GastRefResolverVisitor = class extends GAstVisitor {
  ...
  visitNonTerminal(node) {
    const ref2 = this.nameToTopRule[node.nonTerminalName];
    if (!ref2) {
...
var CodeExample_default = ({
  ...
  effect((code2) => {
    const highlighted = highlightOddo(code2());
    console.log("HERRO!!!!", {
      code: code2(),
      el: codeElement(),
      highlighted
  ...
  return createElement("pre", {
    ...
    ref: computed((codeElement2) => codeElement2(), [codeElement])
...
var GuidePage = () => {
  ...
  return createElement("div", {
    ...
    class: "doc-feature"
  }, createElement("h3", null, "Arrow Function Components"), " ", createElement("p", null, "Components are simple arrow functions. Reactive state and mutations are declared inline with modifiers."), " ", createComponent(CodeExample_default, {
    code: computed((code1) => code1(), [code1_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Mutation with :="), " ", createElement("p", null, "Oddo distinguishes binding (=) from mutation (:=). This makes state changes explicit and predictable."), " ", createComponent(CodeExample_default, {
    code: computed((code2) => code2(), [code2_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Value decorators"), " ", createElement("p", null, "Reactive primitives use the", " ", createJsxExpression((atSign2) => atSign2(), [atSign]), " ", "prefix for clarity. At a glance, you know what is reactive."), " ", createComponent(CodeExample_default, {
    code: computed((code3) => code3(), [code3_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "JSX-First UI"), " ", createElement("p", null, "JSX is a first-class citizen. Build reactive interfaces naturally with familiar syntax."), " ", createComponent(CodeExample_default, {
    code: computed((code4) => code4(), [code4_default])
  }))), " ", createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Hello World"), " ", createElement("p", null, "Here is the simplest Oddo application:"), " ", createComponent(CodeExample_default, {
    code: computed((code5) => code5(), [code5_default])
  }), " ", createElement("p", null, "That is it. No boilerplate, no configuration. Just write and run.")), " ", createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Ready to Explore?"), " ", createElement("p", null, "Head to the", " ", createComponent(A, {
    href: "/api"
  }, createElement("strong", null, "API")), " ", "tab to learn about all the features, or jump into the", " ", createComponent(A, {
    href: "/playground"
  }, createElement("strong", null, "Playground")), " ", "to start writing code immediately."))));
};
...
var APIPage = () => {
  ...
  return createElement("div", {
    ...
    class: "doc-feature"
  }, createElement("h3", null, createJsxExpression((atSign2) => atSign2(), [atSign]), "state"), " ", createElement("p", null, "Declares reactive state. When state changes, dependent UI automatically updates."), " ", createComponent(CodeExample_default, {
    code: computed((codeState) => codeState(), [codeState_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, createJsxExpression((atSign2) => atSign2(), [atSign]), "computed"), " ", createElement("p", null, "Derives values from state. Automatically recalculates when dependencies change."), " ", createComponent(CodeExample_default, {
    code: computed((codeComputed) => codeComputed(), [codeComputed_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, createJsxExpression((atSign2) => atSign2(), [atSign]), "effect"), " ", createElement("p", null, "Runs side effects when dependencies change. Perfect for logging, API calls, or DOM manipulation."), " ", createComponent(CodeExample_default, {
    code: computed((codeEffect) => codeEffect(), [codeEffect_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, createJsxExpression((atSign2) => atSign2(), [atSign]), "mutate"), " ", createElement("p", null, "Defines mutation functions that can safely modify state. Enables batched updates."))), " ", createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Operators"), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Assignment vs Mutation"), " ", createComponent(CodeExample_default, {
    code: computed((codeOps) => codeOps(), [codeOps_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Equality"), " ", createElement("p", null, "Oddo simplifies equality: == always compiles to JavaScript === (strict equality). No type coercion surprises."), " ", createComponent(CodeExample_default, {
    code: computed((codeEquality) => codeEquality(), [codeEquality_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "All Standard Operators"), " ", createElement("p", null, "Arithmetic, logical, comparison, and bitwise operators work as expected."), " ", createComponent(CodeExample_default, {
    code: computed((codeAllOps) => codeAllOps(), [codeAllOps_default])
  }))), " ", createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Data Types"), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Primitives"), " ", createComponent(CodeExample_default, {
    code: computed((codePrimitives) => codePrimitives(), [codePrimitives_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Arrays"), " ", createComponent(CodeExample_default, {
    code: computed((codeArrays) => codeArrays(), [codeArrays_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Objects"), " ", createComponent(CodeExample_default, {
    code: computed((codeObjects) => codeObjects(), [codeObjects_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Arrow Functions"), " ", createComponent(CodeExample_default, {
    code: computed((codeArrows) => codeArrows(), [codeArrows_default])
  }))), " ", createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "JSX Syntax"), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Elements and Components"), " ", createComponent(CodeExample_default, {
    code: computed((codeElements) => codeElements(), [codeElements_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Attributes and Expressions"), " ", createComponent(CodeExample_default, {
    code: computed((codeAttrs) => codeAttrs(), [codeAttrs_default])
  })), " ", createElement("div", {
    class: "doc-feature"
  }, createElement("h3", null, "Children and Nesting"), " ", createComponent(CodeExample_default, {
    code: computed((codeNesting) => codeNesting(), [codeNesting_default])
  }))), " ", createElement("section", {
    class: "doc-section"
  }, createElement("h2", null, "Component Structure"), " ", createElement("p", null, "Components are arrow functions with curly braces. State, mutations, and the return statement go inside:"), " ", createComponent(CodeExample_default, {
    code: computed((codeBlock) => codeBlock(), [codeBlock_default])
  }))));
};
...
// packages/docs/.temp-ssr/server.js
